...
async function getAllMessagesInAChat(chatID) {
    ...
    try {
        ...
        const query = `SELECT cm.*, u.username, u.ROLE AS sender_role FROM ChatMessages cm INNER JOIN Users u ON cm.sender_id = u.user_id WHERE chat_id = @chatID ORDER BY message_id asc`;
